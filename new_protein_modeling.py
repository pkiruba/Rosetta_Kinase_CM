...
#             print (query, template, length, identity, similarity, gaps, score)
    ...
    rank_emboss_hits_dict = emboss_result.set_index("template")["score_rank"].to_dict()
    ...
    rank_rocs_hits_dict = rocs_result.set_index("rocs_pdb")["TanimotoCombo_rank"].to_dict()
